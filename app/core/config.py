...
class Settings:
    ...
    ICP_CONCURRENCY = int(os.getenv("ICP_CONCURRENCY", "10"))        # screener + enrich + ICP — lowered 13→10: gives each
                                                                       # company's enrichment call more headroom against the
                                                                       # 75-110s per-company watchdog under OpenAI TPM pressure
